...
<p align="center">
  <img src=".github/logo.png" alt="Kubuno Books logo" width="128" height="128">
</p>
...
A standalone Rust process that registers with the [core](https://github.com/kubuno/core) at startup; the core proxies its routes (`/api/v1/books/*`) and serves its runtime-loaded React frontend bundle.

- **Backend** — `src/`: Axum + SQLx (PostgreSQL, schema `books`); migrations in `migrations/`.
