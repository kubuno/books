...
All notable changes to **kubuno-books** are documented in this file.
...
- **New Books logo** — a brown hexagon with an open book, used as the
  browser-tab icon and in the applications menu. It replaces the generic
  open-book icon and is raster (PNG) designer artwork; the Books tab icon now
  resolves (the former SVG path pointed at a missing file).
...
[Unreleased]: https://github.com/kubuno/books/compare/v0.1.8...HEAD
[0.1.8]: https://github.com/kubuno/books/releases/tag/v0.1.8
[0.1.7]: https://github.com/kubuno/books/releases/tag/v0.1.7
[0.1.6]: https://github.com/kubuno/books/releases/tag/v0.1.6
